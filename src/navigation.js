...
import DynamicCampus from './dynamicCampus';
import DynamicStudents from './dynamicStudents';
...
function Navigation(){
    ...
    <Router>
      ...
      <Toolbar/>
        ...
        <Route exact path='/Students/:id' component={DynamicStudents} />
        <Route exact path='/Campus/:id' component={DynamicCampus} />
